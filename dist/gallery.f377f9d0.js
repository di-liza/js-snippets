...
})({"dLkez":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "8c9edf71f377f9d0";
"use strict";
...
},{}],"11p9I":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _unsplashApi = require("./unsplash-api");
var _refsGallery = require("./refs-gallery");
...
(0, _refsGallery.refs).searchForm.addEventListener("submit", handleSearchFormSubmit);
(0, _refsGallery.refs).loadMoreBtn.addEventListener("click", handleLoadmoreBtnClick);
function handleSearchFormSubmit(event) {
    event.preventDefault();
    if (!(0, _refsGallery.refs).searchInput.value) return;
    unsplashAPI.query = (0, _refsGallery.refs).searchInput.value.trim();
    getPhotos();
    (0, _refsGallery.refs).searchInput.value = "";
}
async function getPhotos() {
    try {
        const { data  } = await unsplashAPI.fethPhoto();
        console.log(data);
        (0, _refsGallery.refs).gallery.innerHTML = (0, _galleryCardHbsDefault.default)(data.results);
        hideLoadMoreBtn(data);
        (0, _refsGallery.refs).loadMoreBtn.classList.remove("is-hidden");
    } catch (error) {
...
async function handleLoadmoreBtnClick() {
    ...
    try {
        const { data  } = await unsplashAPI.fethPhoto();
        hideLoadMoreBtn(data);
        (0, _refsGallery.refs).gallery.insertAdjacentHTML("beforeend", (0, _galleryCardHbsDefault.default)(data.results));
    } catch (error) {
        console.log(error);
    }
}
function hideLoadMoreBtn(data) {
    if (data.total_pages === unsplashAPI.page || data.total_pages === 0) {
        (0, _refsGallery.refs).loadMoreBtn.classList.add("is-hidden");
        return;
    }
}

},{"./unsplash-api":"itqpZ","./refs-gallery":"iKyNe","../templates/gallery-card.hbs":"fSBUt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"itqpZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class UnsplashAPI {
    ...
    async fethPhoto() {
        try {
            return await (0, _axiosDefault.default).get(`${this.#BASE_URL}/search/photos`, {
                params: {
                    query: this.query,
                    page: this.page,
                    client_id: this.#API_KEY,
        ...
        try {
            const response = await fetch(`${this.#BASE_URL}/search/photos?${searchParams}`);
...
var Buffer = require("f40c15f7b9a1b9b").Buffer;
"use strict";
/**
...
},{"f40c15f7b9a1b9b":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("95a035efa11b51d3");
var ieee754 = require("2b1468e3eceb825a");
...
},{"95a035efa11b51d3":"eIiSV","2b1468e3eceb825a":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iKyNe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const templateFunction = (0, _handlebarsRuntimeDefault.default).template({
    "1": function(container, depth0, helpers, partials, data) {
        ...
        return "<li class='gallery__item'>\r\n    <img src='" + alias1(container.lambda((stack1 = depth0 != null ? lookupProperty(depth0, "urls") : depth0) != null ? lookupProperty(stack1, "small") : stack1, depth0)) + "' alt='" + alias1((helper = (helper = lookupProperty(helpers, "alt_description") || (depth0 != null ? lookupProperty(depth0, "alt_description") : depth0)) != null ? helper : container.hooks.helperMissing, typeof helper === "function" ? helper.call(depth0 != null ? depth0 : container.nullContext || {}, {
...
},{"handlebars/dist/handlebars.runtime":"b7ZpO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dLkez","11p9I"], "11p9I", "parcelRequire10fc")

//# sourceMappingURL=gallery.f377f9d0.js.map
